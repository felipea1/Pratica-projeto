...
public class Average {
	...
	int gradeCounter = 0; // inicializa os numeros de notas inseridas até agora
	...
	// faz um loop até ler o valor de sentinela inserida pelo o usuário
	while (grade != -1) {
		
		total = total + grade; // adiciona a grade a total
		gradeCounter = gradeCounter + 1; // incrementa counter
		
		// solicita entrada e lê a próxima nota fornecida pelo o usuário
		System.out.print("Enter grade or -1 to quit: ");
		grade = input.nextInt();
		}
